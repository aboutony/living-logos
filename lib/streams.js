...
const HUB_PARISHES = {
    ...
    constantinople: [
        { id: "stream-rumorthodox", name: "RumOrthodox", location: "Constantinople (Istanbul), Turkey", lat: 41.0136, lng: 28.9550, lang: "Greek", rite: "CHRYSOSTOM", tier: 2, live: true, viewers: 59500, tz: "Europe/Istanbul", youtubeChannel: { handle: "@rumorthodox9171", channelId: "UCptXeTfaq4WPVl0MJI4dGbg", name: "RumOrthodox", subscribers: 59500, videos: 887, description: "Κανάλι που προάγει την Ορθοδοξία και τη Ρωμηωσύνη — Channel promoting Rum Orthodox Faith and Culture", languages: ["el", "en", "tr", "ru", "bg"] } },
